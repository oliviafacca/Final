...
jundat <- read_csv("June2008.csv") %>%
  mutate(sbodymass = ("body mass (g)" - mean("body mass (g)")) / sd("body mass (g)"))
...
### The formula stands for the general notation for describing models.
### In the second formula each of the different parts stand for individual parts, described below. 
